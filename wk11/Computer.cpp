...
{
    // TODO
    VisitablePart **visitablePart = new VisitablePart*[numberOfRequiredParts + m_numberOfAdditionalParts];
    Part **parts = getAllComputerParts();
    for (int i = 0; i < m_numberOfAdditionalParts + numberOfRequiredParts; ++i)
    {
        visitablePart[i] = dynamic_cast<VisitablePart*>(parts[i]);
    }

    delete[] parts;
    return visitablePart;
}
...
{
    // TODO
    VisitablePart **visitablePart = new VisitablePart*[numberOfRequiredParts];
    for (int i = 0; i < numberOfRequiredParts; ++i)
    {
        visitablePart[i] = dynamic_cast<VisitablePart*>(m_requiredParts[i]);
    }
    return visitablePart;
}
...
{
    // TODO
    VisitablePart **visitablePart = new VisitablePart*[m_numberOfAdditionalParts];
    for (int i = 0; i < m_numberOfAdditionalParts; ++i)
    {
        visitablePart[i] = dynamic_cast<VisitablePart*>(m_additionalParts[i]);
    }
    return visitablePart;
}
