...
int main()
{
    ...
    if (!computerCaseTest())
    {
		cout << "computer case failed" << endl;
        numberOfTestsFailed++;
    }
    if (!computerPowerSupplyTest())
    {
		cout << "computer power supply failed" << endl;
        numberOfTestsFailed++;
    }
    if (!computerMotherboardTest())
    {
		cout << "computer motherboard failed" << endl;
        numberOfTestsFailed++;
    }
    if (!computerCPUTest())
    {
		cout << "computer cpu failed" << endl;
        numberOfTestsFailed++;
    }
    if (!computerRamTest())
    {
		cout << "computer ram failed" << endl;
        numberOfTestsFailed++;
    }
    if (!computerRamDeepCopyTest())
    {
		cout << "computer ram deep copy failed" << endl;
        numberOfTestsFailed++;
    }
    if (!computerHardDrivesTest())
    {
		cout << "computer hard drives failed" << endl;
        numberOfTestsFailed++;
    }
    if (!computerHardDrivesDeepCopyTest())
    {
		cout << "computer hard drives deep copy failed" << endl;
        numberOfTestsFailed++;
    }
    if (!computerGraphicsCardTest())
    {
		cout << "computer graphics card failed" << endl;
        numberOfTestsFailed++;
    }
    if (!computerGraphicsCardDeepCopyTest())
    {
		cout << "computer graphics card deep copy failed" << endl;
        numberOfTestsFailed++;
    }
    if (!computerWaterCoolingTest())
    {
		cout << "computer water cooling test failed" << endl;
        numberOfTestsFailed++;
    }
    if (!computerFanTest())
    {
		cout << "computer fan test failed" << endl;
        numberOfTestsFailed++;
    }
    if (!computerDVDDriveTest())
    {
		cout << "computer dvd drive failed" << endl;
        numberOfTestsFailed++;
    }
    if (!computerBluRayTest())
    {
		cout << "computer blu ray failed" << endl;
        numberOfTestsFailed++;
    }
    if (!buildFullComputerTest())
    {
		cout << "build full computer failed" << endl;
        numberOfTestsFailed++;
    }
    ...
    {
		cout << "create builder failed" << endl;
        numberOfTestsFailed++;
    }
    if (!buildOfficeComputerTest1())
    {
		cout << "build office computer 1 failed" << endl;
        numberOfTestsFailed++;
    }
    if (!buildOfficeComputerTest2())
    {
		cout << "build office computer 2 failed" << endl;
        numberOfTestsFailed++;
    }
    if (!buildOfficeComputerTest3())
    {
		cout << "build office computer 3 failed" << endl;
        numberOfTestsFailed++;
    }
    if (!buildServerTest1())
    {
		cout << "build server 1 faield" << endl;
        numberOfTestsFailed++;
    }
    if (!buildServerTest2())
    {
		cout << "build server 2 failed" << endl;
        numberOfTestsFailed++;
    }
    if (!buildServerTest3())
    {
		cout << "build server 3 failed" << endl;
        numberOfTestsFailed++;
    }
    if (!buildGamingComputerTest1())
    {
		cout << "build gaming computer 1 failed" << endl;
        numberOfTestsFailed++;
    }
    if (!buildGamingComputerTest2())
    {
		cout << "build gaming computer 2 failed" << endl;
        numberOfTestsFailed++;
    }
    if (!buildGamingComputerTest3())
    {
		cout << "build gaming computer 3 failed" << endl;
        numberOfTestsFailed++;
    }
    ...
    {
		cout << "visit bluray using counting visitor failed" << endl;
        numberOfTestsFailed++;
    }
    if (!visitCaseUsingCountingVisitorTest())
    {
		cout << "visit case using counting visitor failed" << endl;
        numberOfTestsFailed++;
    }
    if (!visitCoolingFanUsingCountingVisitorTest())
    {
		cout << "visit cooling fan using couting visitor failed" << endl;
        numberOfTestsFailed++;
    }
    if (!visitCPUUsingCountingVisitorTest())
    {
		cout << "visit cpu using counting visitor failed" << endl;
        numberOfTestsFailed++;
    }
    if (!visitDVDDriveUsingCountingVisitorTest())
    {
		cout << "visit dvd drive using counting visitor failed" << endl;
        numberOfTestsFailed++;
    }
    if (!visitGraphicsCardUsingCountingVisitorTest())
    {
		cout << "visit graphics card using counting visitor failed" << endl;
        numberOfTestsFailed++;
    }
    if (!visitHardDriveUsingCountingVisitorTest())
    {
		cout << "visit hard drive using counting visitor failed" << endl;
        numberOfTestsFailed++;
    }
    if (!visitMotherboardUsingCountingVisitorTest())
    {
		cout << "visit motherboard using counting visitor failed" << endl;
        numberOfTestsFailed++;
    }
    if (!visitPowerSupplyUsingCountingVisitorTest())
    {
		cout << "visit power supply using counting visitor failed" << endl;
        numberOfTestsFailed++;
    }
    if (!visitRamUsingCountingVisitorTest())
    {
		cout << "visit ram using counting visitor failed" << endl;
        numberOfTestsFailed++;
    }
    if (!visitWaterCoolingUsingCountingVisitorTest())
    {
		cout << "visit water cooling using counting visitor failed" << endl;
        numberOfTestsFailed++;
    }
    if (!visitOptionalPartsUsingCountingVisitorTest())
    {
		cout << "visit optional parts using counting visitor failed" << endl;
        numberOfTestsFailed++;
    }
    if (!visitRequiredPartsUsingCountingVisitorTest())
    {
		cout << "visit required parts using counting visitor failed" << endl;
        numberOfTestsFailed++;
    }
    if (!visitAllPartsUsingCountingVisitorTest())
    {
		cout << "visit all parts using counting visitor failed" << endl;
        numberOfTestsFailed++;
    }
